...
export const generateMockup = async (
  ...
  try {
    ...
    1. MATERIAL INTEGRATION: The logo must physically interact with the product's material. 
       - If fabric/clothing: Apply realistic displacement, following wrinkles, folds, and weave texture. The ink/print should look absorbed or heat-pressed, not floating.
       - If hard surface (bottle, box, tech): Apply correct curvature wrapping and specular reflections consistent with the material (matte vs glossy).
    
    2. LIGHTING MATCH: Analyze the scene lighting (direction, intensity, color, hardness). Apply identical lighting to the applied graphics including cast shadows and self-shadowing.
    
    3. PHOTOREALISM: The final output must look like a high-end commercial product photograph (4k, sharp focus). No "sticker effect". The compositing should be imperceptible.
    
    Follow the Layout Guidance for positioning, but prioritize realistic surface warping, lighting, and perspective blending over precise coordinate adherence if it improves realism.
